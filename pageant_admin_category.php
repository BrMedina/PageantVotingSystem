...
<body>
  ...
  <hr>
        ...
        <span>Pageant Setup</span>
            ...
            <!-- Category -->
          <li><a href="pageant_admin_category.php" class="nav-link text-white active">
    ...
    <main class="content-wrapper p-5 bg-light">
      ...
      <div class="p-4 bg-yellow shadow text-white justify-content-center align-items-center">
        <h1 class="display-3 fw-bold">Pageant Categories</h1>
      ...
      <form action="pageant_admin_category.php" method="post">
          <div class="row g-3">
              <div class="col">
