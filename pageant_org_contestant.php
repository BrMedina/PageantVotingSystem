...
?>
<!-- Pageant ORGANIZER > Contestants page -->
<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
<body>
  ...
  <hr>
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            ...
            <!-- Contestants -->
          <li class="nav-item"><a href="pageant_org_contestant.php" class="nav-link text-white active">
    ...
    <main class="content-wrapper p-5 bg-light">
      ...
      <div class="p-4 bg-yellow shadow text-white justify-content-center align-items-center">
        <h1 class="display-3">Contestant</h1>
      ...
      <form action="pageant_org_contestant.php" method="post">
          <div class="row g-3">
              <div class="col">
