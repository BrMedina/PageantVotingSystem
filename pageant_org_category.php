...
?>
<!-- Pageant ORGANIZER > Category page -->
<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
<body>
  ...
  <hr>
        ...
        <ul class="nav nav-pills flex-column mb-auto">
          ...
          <li class="nav-item"><a href="pageant_org_contestant.php" class="nav-link text-white">
            ...
            <!-- Category -->
          <li><a href="pageant_org_category.php" class="nav-link text-white active">
            <img src="imagespvs/category.png" alt="" width="20" height="20" class="me-2">Pageant Categories</a></li>

            <!-- Criteria -->
          <li><a href="pageant_org_criteria.php" class="nav-link text-white">
    ...
    <main class="content-wrapper p-5 bg-light">
      ...
      <div class="p-4 bg-yellow shadow text-white justify-content-center align-items-center">
        <h1 class="display-3">Pageant Categories</h1>
         <p class="lead">Configure Category List</p>
       
      </div>
      <br>
      
      <!-- Display Table ==== INSERT TABLE BELOW ==== -->
      <form action="pageant_org_category.php" method="post">
          <div class="row g-3">
              <div class="col">
 ...
 if (isset($_POST['btnsearch'])) {
    ...
    if ($searchinput != NULL) {
        ...
        $displaysql = "Select * from tbl_category WHERE 
        category_name LIKE '%".$searchinput."%'
        OR category_id LIKE '%".$searchinput."%'
        OR category_description LIKE '%".$searchinput."%'
        "; 

    } else {

        $displaysql = "Select * from tbl_category"; 
...
if ($result->num_rows > 0) { 
    ...
    foreach ($result as $index => $fieldname) {
      $categoryImage = '';
      $categoryDescription = '';
      if (isset($fieldname['category_image'])) {
        $categoryImage = $fieldname['category_image'];
      }
      if (isset($fieldname['category_description'])) {
        $categoryDescription = $fieldname['category_description'];
      }
?>
    ...
    <div class="col-4">
        <div class="container p-3 m-3 bg-secondary text-white rounded shadow">
            ...
            <div class="row">
              ...
              <img src="<?php echo $categoryImage; ?>" alt="" width="200" height="150" class="img-fluid rounded">
            </div>
        </div>
        
            <div class="row">
                <div class="col">
                    <h5><?php echo $fieldname['category_name'] ?></h5>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col">
                    <i class="small">
                        Category ID:
                        <?php echo $fieldname['category_id'] ?>
                    </i>
                </div>
            </div>
